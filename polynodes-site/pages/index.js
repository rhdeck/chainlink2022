  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.mainnologo}>
        ...
        <p className={styles.indexText}>
          With the click of a button, create and deploy <a href= "https://polygon.technology" target="_blank">Polygon</a> nodes to run on <a href = "https://chain.link/" target="_blank">Chainlink</a>. Make your job as easy as defining a javascript lambda.
        </p>
        <p className={styles.indexText}>
